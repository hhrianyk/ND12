...
class MainWindow(CTk):
    def __init__(self):
        ...
        # --- БОКОВЕ МЕНЮ ---
        self.menu_frame = CTkFrame(self, width=30, height=300,fg_color='#91C6BC')
        ...
        self.chat_field = CTkScrollableFrame(self, fg_color="#4B9DA9")
    ...
    def add_message(self, message, img=None):
        message_frame = CTkFrame(self.chat_field, fg_color="purple")
